...
module.exports = Player = (function(){
  ...
  function Player(x, y){
    ...
    this.sprite = new AnimatedSprite(assets.MyChar, 0, 0, kTileSize, kTileSize, 15, 3);
  }
  prototype.update = function(elapsedTime){
    return this.sprite.update(elapsedTime);
  };
